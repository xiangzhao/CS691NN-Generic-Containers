...
In this final benchmark, we see the performance of our adaptive sequence
is pretty much the same with the vector and list. However, the dequeue
performs the worst probably because the operations involve many insertions
and sorting.
