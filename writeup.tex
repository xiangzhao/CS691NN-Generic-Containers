...
in this fashion. It generates 10,000 random sequence operations
and then loops across this sequence, replaying it on each of the four
possible sequences.The operations are push back, insert, sort, and random access. 

In this final benchmark, We see the performance of our adaptive sequence is pretty much the same with the vector and list. However, the dequeue performs the worst probably because the operations invovle many insertions and sorting. 
